...
const AddressInfo = ({text, info}: AddressInfoProps) => {
  return ( 
    <div 
      ...
      md:items-start md:text-start md:before:content-[''] 
      md:before:absolute md:before:right-2 md:before:top-0 
      md:before:w-[.1rem] md:before:h-full md:before:bg-tw-dark-gray
      ">
